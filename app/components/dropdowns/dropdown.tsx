...
interface InternalDropdownOptionProps extends DropdownOptionProps {
  onClick?: () => void;
  isSelected?: boolean;
}
  ...
  const options = React.Children.map(children, (child) => {
    if (
      ...
      return React.cloneElement(child, {
        onClick: () =>
          handleSelect(optionValue, typeof optionLabel === 'string' ? optionLabel : ''),
        isSelected: optionValue === selectedValue,
      } as InternalDropdownOptionProps);
    }
    return child;
  });
...
export const DropdownOption = React.forwardRef<
  HTMLDivElement,
  DropdownOptionProps & { onClick?: () => void; isSelected?: boolean }
